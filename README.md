## CS-499 Computer Science Capstone- Final Project ![image](https://github.com/user-attachments/assets/59c97a66-7304-4e61-b1bf-fa51c45ed2b8)
...
Throughout the course, I have achieved all five course outcomes across different enhancements and code review. During the creation of my code review video, I successfully achieved the course outcome of designing, developing, and delivering professional-quality communications.  In Enhancement-1 (Software Engineering and Design), I effectively employed strategies for building collaborative environments by integrating diverse feedback into the text-based adventure game, while also creating professional, coherent, and audience-appropriate documentation. Additionally, I designed and evaluated algorithmic solutions, managing trade-offs in data structures and algorithms, and implemented innovative, value-driven solutions using industry-standard practices in my Python code. In Enhancement-2 (Data Structures and Algorithms), I demonstrated my ability to design and evaluate computing solutions using advanced data structures like linked lists and unordered maps, and showcased innovative techniques and tools to develop robust software solutions. Furthermore, I delivered professional-quality written communications by improving code readability and organization. Finally, in Enhancement-3 (Databases), I developed a security mindset by implementing regular updates and access controls, ensuring data privacy and security, and used innovative techniques with MongoDB to manage and analyse data effectively, demonstrating my skills in delivering value through computing practices.
